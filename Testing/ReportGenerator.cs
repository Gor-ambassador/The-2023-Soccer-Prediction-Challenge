    ...
    internal class ReportGenerator
    {
            ...
            List<(string season, string champ, string home, string away, int scGH, int scGA, double prW, double prD, double prL, int prGH, int prGA)> results)
        {
            ...
            using (var package = new ExcelPackage(new FileInfo("Report.xlsx")))
            {
                ...
                sheet.Cells["A3"].Value = "Minimum";
                sheet.Cells["B3"].Formula = "MIN('SortedRPS'!E2:E" + (RPSes.Count + 1).ToString() + ")";
                sheet.Cells["A4"].Value = "25%";
                sheet.Cells["B4"].Formula = "QUARTILE('SortedRPS'!E2:E" + (RPSes.Count + 1).ToString() + ",1)";
                sheet.Cells["A5"].Value = "50%";
                sheet.Cells["B5"].Formula = "QUARTILE('SortedRPS'!E2:E" + (RPSes.Count + 1).ToString() + ",2)";
                sheet.Cells["A6"].Value = "75%";
                sheet.Cells["B6"].Formula = "QUARTILE('SortedRPS'!E2:E" + (RPSes.Count + 1).ToString() + ",3)";
                sheet.Cells["A7"].Value = "Maximum";
                sheet.Cells["B7"].Formula = "MAX('SortedRPS'!E2:E" + (RPSes.Count + 1).ToString() + ")";

                sheet.Cells["D1"].Value = "RMSE";
                sheet.Cells["D2"].Value = "Mean";
                sheet.Cells["E2"].Formula = "SQRT(AVERAGE('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + "))";
                sheet.Cells["D3"].Value = "Minimum";
                sheet.Cells["E3"].Formula = "SQRT(MIN('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + "))";
                sheet.Cells["D4"].Value = "25%";
                sheet.Cells["E4"].Formula = "SQRT(QUARTILE('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + ",1))";
                sheet.Cells["D5"].Value = "50%";
                sheet.Cells["E5"].Formula = "SQRT(QUARTILE('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + ",2))";
                sheet.Cells["D6"].Value = "75%";
                sheet.Cells["E6"].Formula = "SQRT(QUARTILE('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + ",3))";
                sheet.Cells["D7"].Value = "Maximum";
                sheet.Cells["E7"].Formula = "SQRT(MAX('SortedRMSE^2'!E2:E" + (RMSEes.Count + 1).ToString() + "))";
